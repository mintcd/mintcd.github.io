...
export default function Home() {
  return (
    <div className="m-8 sm:m-16">
      ...
      <br />
      <br />
      What keeps me alive is the fact that what I have to do possibly takes longer time than my live. In these wonders, I found my only. I shall love her forever, Thanh Ngan. If you have found a contradiction between my claim of meaninglessness and my love, I will explain this in my later blog. Keep following!
      <br />
      <br />
    </div>
  )
